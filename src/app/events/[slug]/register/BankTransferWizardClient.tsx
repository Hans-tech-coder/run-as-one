...
export default function BankTransferWizardClient({
  ...
  // matching the amount the runner is told to transfer.
  ...
  // code are weighed together and the largest wins — an early bird stacking
  // on top of a voucher is a number the organizer never agreed to.
      ...
      <div className="wizard-container py-12 t-stagger is-shown">
        ...
        >
          ...
          <div className="glass-panel p-8 form-panel border border-white/10 bg-gradient-to-b from-white/5 to-transparent rounded-3xl relative overflow-clip">
            ...
            {step === 3 && (
              <div className="step-content relative z-10 animate-fade-in">
                {/* Above the amount, not below it: this runner is about to
                    transfer that exact figure by hand, so a code applied after
                    they had read it would be a code applied too late. */}
                <PromoCodeField
                  eventId={eventId}
                  promo={promo}

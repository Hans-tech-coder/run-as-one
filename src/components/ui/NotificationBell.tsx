...
/**
 * The dashboard's notification bell: a round button whose bell swings when the
 * count goes up, with a badge whose digits roll to the new number.
 *
 * Adapted from the reference component the owner supplied. Two changes from
 * it: it imports `framer-motion` (the package this project already ships —

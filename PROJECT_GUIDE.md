...
**`SUPERADMIN_APPLICATIONS_PLAN.md` is an open queue, with Batches 1–3 landed.**
...
action and `decisionEmailSentAt` were not built. **Batch 4 (the audit row per
decision) is next.**

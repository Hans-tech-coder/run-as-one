...
- **A client viewer reaches registrant counts of its own client's events and
  ...
  `admin/profile` and `admin/profile/password` serve it. **A new dashboard page
...
**`ADMIN_MERGE_PLAN.md` is the active queue — Batches 1–4 have landed (2026-09-17).**
